                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="form-group form-primary">
                                    ...
                                    <label for="user" class="float-label">Nombre de usuario</label>
                                </div>
                                <div class="form-group form-primary">
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <p>¿Eres revendedor? <a href="<?= url_login_resellers() ?>">Ingresa como revendedor</a></p>
                                    </div>
                                    <div class="col-md-2">
    ...
    <script>
        function validarLogin() {
            ...
            $.ajax({
                ...
                url: "<?= base_url("directory/services/internal/login") ?>",
                type: 'post',
                data: formData,
                contentType: false,
                processData: false,
                success: function(response) {
                    ...
                    console.log(responseParse.error);
                    switch ($.trim(responseParse.error)) {
                        case "false":
                            $.toast({
                                heading: 'Success',
