        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="input-group mb-3">
                    ...
                    &nbsp;&nbsp;<a id="rPassword" href="#" onclick="javascript:reesetPasswordVendedor()">Resetear credenciales.</a>
                </div>
...
<?= setAlertConfirmUpdate("confirmarUpdatePassword", base_url("CComisiones/reesetPasswordVendedor")); ?>

<script>
    function reesetPasswordVendedor() {
        var inputsuser = validarInputUser();
        if (inputsuser.trimiado) {
            var data = `{"lg_usuarios_nombre":"${inputsuser.lg_usuario}","lg_usuarios_correo":"${inputsuser.lg_correo}","lg_external_id":"${$("#Eidvendedor").val()}"}`;
            var dataobj = JSON.parse(data);
            confirmarUpdatePassword(dataobj);

        } else {
            <?= setAlert("No fue posible reesetear el usuario porque los campos no estaban llenados correctamente", "error", false) ?>;
