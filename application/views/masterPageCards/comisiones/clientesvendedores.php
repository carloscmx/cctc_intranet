            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        ...
                        <p class="m-b-0">Modulo -Clientes de vendedores.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <!-- <ul class="breadcrumb">
...
echo setDataTable("tableClientes", "tClientes", base_url("CComisiones/getClients"), array("nombrecompleto", "companyname", "email", "buttons", "vendedor"));

?>
<script>
    tableClientes.columns(4).visible(false).draw();
</script>
<script>
    function busquedaPorVendedor(input) {
        if (input.value == 0) {
            tableClientes.columns(4).search("").draw();

        } else {
            tableClientes.columns(4).search(input.value).draw();
        }
    }
</script>
<script>
    function cambiarVendedor(vendedor, cliente) {
        ...
        $.ajax({
            url: "<?= base_url("CComisiones/insertVendedoresCliente") ?>",
