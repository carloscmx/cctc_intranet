            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    <div class="page-header-title">
                        ...
                        <p class="m-b-0">Modulo Reportes de Panel Blazar.</p>
                    </div>
                </div>
                <div class="col-md-4">
                    <!--     <ul class="breadcrumb">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5>Reporte Panel Blazar</h5>
                                    <span>Seleccione un vendedor y un mes para generar el reporte.</span>
...
<script>
    ...
    function generarReporte() {
        ...
        if (vendedor != 0) {
            $.ajax({
                url: "<?= base_url("CComisiones/getInvoicesForVendedor") ?>",
                method: "POST", //First change type to method here
                data: {
