        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form class="md-float-material form-material" id="formValidar" onsubmit="return preventSubmit(event)">
                        ...
                        <div class="auth-box card">
                            ...
                            <div class="card-block">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="button" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20" onclick="validarLogin()">Inicia sesión</button>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        <p class="text-inverse text-left m-b-0">
                                            BLAZAR NETWORKS, SA DE CV© 2021. All rights reserved.
                                            .</p>
                                        <p class="text-inverse text-left"><a href="https://panel.blazar.mx"><b>Regresar a Panel Blazar</b></a></p>
                                    </div>
                                    <div class="col-md-2">
    ...
    <script>
        function validarLogin() {
            ...
            $.ajax({
                ...
                url: "<?= base_url("CLogin/validarLogin") ?>",
                type: 'post',
                data: formData,
                contentType: false,
                processData: false,
