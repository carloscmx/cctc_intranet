                        ...
                        <ul class="nav-right">
                                ...
                                <ul class="show-notification">
                                    ...
                                    <li class="waves-effect waves-light">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h5 class="notification-user">Hola <?= $datos['ven_nombre'] ?></h5>
                            ...
                            <li class="user-profile header-notification">
                                <a href="#!" class="waves-effect waves-light">
                                    ...
                                    <span><?= $datos['ven_nombre'] . " " . $datos['ven_ape_pat'] ?></span>
                            ...
                            <div class="">
                                <div class="main-menu-header">
                                    ...
                                    <div class="user-details">
                                        <span id="more-details"><?= $datos['ven_nombre'] . " " . $datos['ven_ape_pat'] ?><i class="fa fa-caret-down"></i></span>
                                    </div>
                                </div>
                                ...
                                <li class="pcoded-hasmenu" id="menu_comisiones">
                                    ...
                                    <ul class="pcoded-submenu">
                                        ...
                                        <li class="" id="submenu_vendedoresclientes">
                                            <a href="<?= base_url("directory/vendedores/vendedores-clientes") ?>" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">Mis Clientes</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li id="submenu_vendedores_reportes">
                                            <a href="<?= base_url("/directory/vendedores/reportes/panel") ?>" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">Reportes - Panel Blazar</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
                                        <li id="submenu_vendedores_cctc">
                                            <a href="#" class="waves-effect waves-dark">
                                                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                                                <span class="pcoded-mtext">Reportes - CCTC (No Disponible)</span>
                                                <span class="pcoded-mcaret"></span>
                                            </a>
                                        </li>
