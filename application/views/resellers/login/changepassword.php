                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-center">Hola <?= $datos['name'] ?></h3>
                                    </div>
                                </div>
                                ...
                                <div class="form-group form-primary">
                                    ...
                                    <span class="form-bar"></span>
                                    <label for="password1" class="float-label"> Repeat the password</label>
                                </div>

                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <button type="button" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20" onclick="javascript:changePassword()">Cambiar contraseña</button>
                                    </div>
                                </div>
                                <hr />
                                <div class="row">
                                    <div class="col-md-10">
                                        <p class="text-inverse text-left m-b-0">Antes de empezar necesitas cambiar tu contraseña (Minimo 6 caracteres).</p>
